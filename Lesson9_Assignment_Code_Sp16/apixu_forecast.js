...
/*  Section #4:  AJAX code to send the HTTP Request, which is the location the user specifies, to the 
    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 Use the following code as an example:
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key=fe4629fbc31b4141ba0155843162504&q=Paris',
...
*/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=fe4629fbc31b4141ba0155843162504&q',
                      data: message             
                })
                .done(function(json){
                     ...
                     $('#Day7High').html("<center>" + json.forecast.forecastday[6].day.mintemp_f + "</center>");
                     $('#Day8Low').html("<center>" + json.forecast.forecastday[7].day.mintemp_f + "</center>");
                     $('#Day8High').html("<center>" + json.forecast.forecastday[7].day.mintemp_f + "</center>");
                     $('#Day9Low').html("<center>" + json.forecast.forecastday[8].day.mintemp_f + "</center>");
                     $('#Day9High').html("<center>" + json.forecast.forecastday[8].day.mintemp_f + "</center>");
                     $('#Day10Low').html("<center>" + json.forecast.forecastday[9].day.mintemp_f + "</center>");
                     $('#Day10High').html("<center>" + json.forecast.forecastday[9].day.mintemp_f + "</center>");
